...
if (url.includes("/detail_modul/article_releated_modul") && obj.data.lanmu_qikan) {
  delete obj.data.lanmu_qikan;
}

if (url.includes("/sou/search_keyword_redirect_urls") && obj.data) {
  delete obj.data;
}
